    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-lg mx-auto text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 mb-2">Failed to load sync status</h2>
          <p className="text-gray-600 mb-6 text-sm">
            {error.message || 'There was a problem loading sync data. The NinjaOne service may be temporarily unavailable.'}
          </p>
          <button
            onClick={reset}
