...
## Status: ✅ v2 Shipped (Equipment + Network Inventory) — live at https://app-ems-bp-prod.azurewebsites.net
...
| 10. Deferred Features | [10-deferred-features.md](./10-deferred-features.md) | ✅ Closed (shipped elsewhere or dropped) | — |
...
| 19. Docs + Polish | [19-network-docs-polish.md](./19-network-docs-polish.md) | ✅ Complete | — |
...
- **Network inventory is manual-entry + CSV/XLSX import** — Auvik shipped as the optional sync (Phase 17), ran once to seed the inventory, and was removed in Phase 22 along with its env vars, cron, and `is_manually_overridden` flag.
...
- [x] Is the tickets table needed or should it be removed from schema? → **Retained** — ticketing is handled by the IT Response Agent (Phase 11); the table stays (Phase 10 closure).
